...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        # self.tabWidget =QTabWidget(self)  # 生成的 Tab Wighte
        # # self.tabWidget.setGeometry(QtCore.QRect(40, 60, 281, 161))
        # self.tabWidget.setLayoutDirection(Qt.LeftToRight)
        # self.tabWidget.setObjectName("tabWidget")
        # self.tab = QWidget()  # 第一个 tab 标签按钮
        # self.tab.setObjectName("tab")
        # # self.textEdit_1 = QtWidgets.QTextEdit(self.tab)  # 第一个 Edit Text
        # # self.textEdit_1.setGeometry(QtCore.QRect(80, 30, 104, 71))
        # # self.textEdit_1.setObjectName("textEdit_1")
        # self.tabWidget.addTab(self.tab, "")
        # self.tab_2 = QWidget("tab_2")  # 第2个 tab 标签按钮
        # # self.textEdit_2 = QtWidgets.QTextEdit(self.tab_2)  # 第2个 Edit Text
        ...
        # 串口连接按钮
        self.btn_connect = QPushButton("串口连接")
    ...
    def onBtnConnect(self):
        ...
        if self.serial_port.open(QIODevice.ReadWrite):
            self.receive_text.append("{} 已连接，可以开始检测!".format(port_name))
        else:
